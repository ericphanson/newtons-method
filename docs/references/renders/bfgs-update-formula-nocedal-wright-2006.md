...
**Source:** [bfgs-update-formula-nocedal-wright-2006.json](../../citations/bfgs-update-formula-nocedal-wright-2006.json)
...
> The update formula for $B_k$ is obtained by simply applying the Sherman–Morrison–Woodbury formula (A.28) to (6.17) to obtain $B_{k+1} = B_k - \frac{B_k s_k s_k^T B_k}{s_k^T B_k s_k} + \frac{y_k y_k^T}{y_k^T s_k}$.
...
### Formula 1 - BFGS update formula (6.19)
...
![Proof page 1](../extracted-pages/numericaloptimization2006_page_0160.png)
