import { DataPoint, computeLossAndGradient, norm, scale, add, sub } from '../shared-utils';
...
export const runGradientDescent = (
  ...
  const { maxIter, alpha, lambda = 0, initialPoint, tolerance = 1e-6, termination } = options;
