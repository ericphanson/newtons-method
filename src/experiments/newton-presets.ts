...
export const newtonExperiments: ExperimentPreset[] = [
  ...
  },
  {
    ...
    name: 'Failure: Perceptron Won\'t Converge',
    description: 'Perceptron with tiny regularization causes nearly singular Hessian, Newton oscillates',
  ...
  },
  {
    ...
    name: 'Fixed: Perceptron with Hessian Damping',
    description: 'Same perceptron problem but with Hessian damping for numerical stability',
    problem: 'separating-hyperplane',
    separatingHyperplaneVariant: 'perceptron',
    hyperparameters: {
      c1: 0.0001,
